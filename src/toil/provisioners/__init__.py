...
def clusterFactory(provisioner, clusterName=None, zone=None, nodeStorage=50, nodeStorageOverride=None, sseKey=None):
    """
    ...
    if provisioner == 'aws':
        try:
            ...
            raise
        return AWSProvisioner(clusterName, zone, nodeStorage, nodeStorageOverride, sseKey)
